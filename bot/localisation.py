...
class Localisation:
    ...
    SAVED_CUSTOM_THUMB_NAIL = "Custom video / file thumbnail successfully saved ✅.\n This image will be used in the video / file."
